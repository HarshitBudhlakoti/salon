...
const PackageCard = ({ image, title, delay = 0 }: PackageCardProps) => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="bg-white border-2 border-gray-200 rounded-2xl overflow-hidden transition-all duration-300 hover:scale-105 hover:border-green-300 flex flex-col h-full"
    >
      {/* Image Container */}
